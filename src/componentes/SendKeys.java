...
public class SendKeys {
    ...
    public SendKeys(Robot robot, String keys) {
        ...
        for (char c : keys.toCharArray()) {
            ...
            try {
                ...
                // caracteres especiais inseridos por comandos da tecla ALT
                switch (c) {
                    case '☺':
                        altNumpad("1");
                        break;
    ...
    // executa o comando da tecla ALT
    ...
    // retorna o codico da tecla numeral para a execução do comando da tecla ATL
